...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Intranet\UserBundle\Form\ProfileFormType A Intranet\UserBundle\Form\ProfileFormType instance.
     */
    protected function getApp_Form_ProfileService()
    {
        return $this->services['app.form.profile'] = new \Intranet\UserBundle\Form\ProfileFormType();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Intranet\UserBundle\Form\RegistrationType A Intranet\UserBundle\Form\RegistrationType instance.
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \Intranet\UserBundle\Form\RegistrationType();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'Eureka', 'user' => 'root2', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_bbdc3b8154bb6bfbae2beba115c11d15dbd7f3754d299108c305f0ac359d3da4');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Intranet\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Intranet\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Intranet\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Intranet\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Intranet\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Intranet\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Intranet/login');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Intranet/register');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Intranet');
        ...
        $n = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '9376743cf43f8d434fc653c2ac06a23bdead37cb', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $o = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $m, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($m, 'fos_user_security_login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        ...
        $p->setOptions(array('login_path' => 'fos_user_security_login', 'default_target_path' => 'intranet_accueil', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Intranet/PlatformBundle/Resources/views'), 'IntranetPlatform');
        $instance->addPath(($this->targetDirs[3].'/src/Intranet/UserBundle/Resources/views'), 'IntranetUser');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/Core/AccueilBundle/Resources/views'), 'CoreAccueil');
        $instance->addPath(($this->targetDirs[3].'/src/Core/ContactBundle/Resources/views'), 'CoreContact');
        $instance->addPath(($this->targetDirs[3].'/src/Core/PresentationBundle/Resources/views'), 'CorePresentation');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9376743cf43f8d434fc653c2ac06a23bdead37cb');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(), 'ROLE_USER' => array()));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'IntranetPlatformBundle' => 'Intranet\\PlatformBundle\\IntranetPlatformBundle',
                'IntranetUserBundle' => 'Intranet\\UserBundle\\IntranetUserBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'CoreAccueilBundle' => 'Core\\AccueilBundle\\CoreAccueilBundle',
                'CoreContactBundle' => 'Core\\ContactBundle\\CoreContactBundle',
                'CorePresentationBundle' => 'Core\\PresentationBundle\\CorePresentationBundle',
            ...
            'secret' => '9376743cf43f8d434fc653c2ac06a23bdead37cb',
            'locale' => 'en',
            ...
            'kernel.secret' => '9376743cf43f8d434fc653c2ac06a23bdead37cb',
            ...
            'fos_user.model.user.class' => 'Intranet\\UserBundle\\Entity\\User',
